...
const CreateAdornment = ({subcategoryName}: CreateOutfitProps) => {
        ...
        <form onSubmit={onSubmit}>
            <div className='row mt-4 mb-5'>
                ...
                <div className='col-md-5'>
                    ...
                    <p className='text-start mb-2 mt-2 fs-5' style={{marginBottom: 0}}>Масса: </p>
                    <input
                    type="text"
                    value={productVolume}
...
export default CreateAdornment;