...
const CreateTechnique = ({subcategoryName}: CreateOutfitProps) => {
    ...
    const [productDiagonal, setProductDiagonal] = useState('')
    ...
    const onSubmit = async (e: FormEvent) => {
        ...
        formData.append("matrix", productMatrix);
        formData.append("diagonal", productDiagonal);
        ...
        <form onSubmit={onSubmit}>
            <div className='row mt-4 mb-5'>
                ...
                <div className='col-md-5'>
                    <p className='text-start mb-2 mt-2 fs-5' style={{marginBottom: 0}}>Название товара: </p>
                    <input
                    type="text"
                    value={productName}
                    ...
                    <p className='text-start mb-2 mt-2 fs-5' style={{marginBottom: 0}}>Видеокарта: </p>
                    <input
                    type="text"
                    value={productGpu}
                    ...
                    <p className='text-start mb-2 mt-2 fs-5' style={{marginBottom: 0}}>Процессор</p>
                    <input
                    type="text"
                    value={productCpu}
                    ...
                    <p className='text-start mb-2 mt-2 fs-5' style={{marginBottom: 0}}>Оперативная память</p>
                    <input
                    type="text"
                    value={productRam}
                    ...
                    className="form-control w-100"
                    id="floatingInput"
                    placeholder="Наименование оперативной памяти"
                    />

                    <p className='text-start mb-2 mt-2 fs-5' style={{marginBottom: 0}}>Матрица монитора: </p>
                    <input
                    type="text"
                    value={productMatrix}
                    onChange={(e) => setProductMatrix(e.target.value)}
                    className="form-control w-100"
                    id="floatingInput"
                    placeholder="Название матрицы монитора"
                    />

                    <p className='text-start mb-2 mt-2 fs-5' style={{marginBottom: 0}}>Диагональ монитора: </p>
                    <input
                    type="text"
                    value={productDiagonal}
                    onChange={(e) => setProductDiagonal(e.target.value)}
                    className="form-control w-100"
                    id="floatingInput"
                    placeholder="Название диагонали монитора"
                    />
